...
try:
    from bio.bioinformatics.metabolic_pathway_simulator import run
except ImportError:
    pytest.skip("Module bio.bioinformatics.metabolic_pathway_simulator not found, skipping tests.")
