...
try:
    from network.interplanetary.deep_space_link_planner import run
except ImportError:
    pytest.skip("Module network.interplanetary.deep_space_link_planner not found, skipping tests.")
