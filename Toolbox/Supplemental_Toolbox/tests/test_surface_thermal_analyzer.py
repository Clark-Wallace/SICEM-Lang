...
try:
    from simulation.planetary.surface_thermal_analyzer import run
except ImportError:
    pytest.skip("Module simulation.planetary.surface_thermal_analyzer not found, skipping tests.")
