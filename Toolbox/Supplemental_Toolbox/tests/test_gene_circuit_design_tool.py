...
try:
    from bio.synthetic_biology.gene_circuit_design_tool import run
except ImportError:
    pytest.skip("Module bio.synthetic_biology.gene_circuit_design_tool not found, skipping tests.")
