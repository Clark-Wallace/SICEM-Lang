...
try:
    from cognitive.load.cognitive_strategy_recommender import run
except ImportError:
    pytest.skip("Module cognitive.load.cognitive_strategy_recommender not found, skipping tests.")
