...
try:
    from simulation.planetary.radiation_flux_calculator import run
except ImportError:
    pytest.skip("Module simulation.planetary.radiation_flux_calculator not found, skipping tests.")
