...
try:
    from data.forecasting.infrastructure_risk_analyzer import run
except ImportError:
    pytest.skip("Module data.forecasting.infrastructure_risk_analyzer not found, skipping tests.")
