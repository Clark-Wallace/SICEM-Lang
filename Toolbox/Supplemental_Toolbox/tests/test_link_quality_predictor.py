...
try:
    from network.interplanetary.link_quality_predictor import run
except ImportError:
    pytest.skip("Module network.interplanetary.link_quality_predictor not found, skipping tests.")
